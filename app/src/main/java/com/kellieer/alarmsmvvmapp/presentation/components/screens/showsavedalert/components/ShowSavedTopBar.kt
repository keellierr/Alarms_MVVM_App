package com.kellieer.alarmsmvvmapp.presentation.components.screens.showsavedalert.components
...
@Composable
fun ShowSavedTopBar(navController: NavHostController) {
                    ...
                    modifier = Modifier
                        ...
                        .clickable {
                            ...
                            when (label) {
                                ...
                                "Rechazados" -> {
                                    navController.navigate(AppScreens.ShowRefuseAlertScreen.route)
                                }
                                "Eliminados" -> {
