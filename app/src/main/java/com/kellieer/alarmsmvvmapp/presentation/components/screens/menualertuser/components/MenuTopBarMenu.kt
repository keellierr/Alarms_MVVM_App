...
fun MenuTopBarMenu(navController: NavHostController) {
    ...
    val selectedItem = remember { mutableStateOf("Mis reportes") }
                ...
                Row(
                    ...
                    modifier = Modifier
                        ...
                        .clickable {
                            ...
                            when (label) {
                                "Mis reportes" -> navController.navigate(AppScreens.MenuAlertUserScreen.route)
                                "Explorar reportes nuevos" -> navController.navigate(AppScreens.MenUserScreen.route)
                                "Guardados" -> navController.navigate(AppScreens.ShowSavedAlertScreen.route)
                                "Rechazados" -> navController.navigate(AppScreens.ShowRefuseAlertScreen.route)
                                "Eliminados" -> navController.navigate(AppScreens.ShowRemoveAlertScreen.route)
