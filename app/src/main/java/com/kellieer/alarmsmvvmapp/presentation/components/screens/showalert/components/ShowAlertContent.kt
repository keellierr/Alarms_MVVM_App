package com.kellieer.alarmsmvvmapp.presentation.components.screens.showalert.components
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            Row(
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Column {
                        Text("Alerta Accidente", fontWeight = FontWeight.Bold)
                        Text("Marzo 7, 04:12 Am", fontSize = 12.sp, color = Color.Gray)
                    }
                }
            ...
            Box(
                ...
                Icon(Icons.Default.MoreVert, contentDescription = null, modifier = Modifier.size(40.dp), tint = Color.DarkGray)
            }

            Spacer(modifier = Modifier.height(12.dp))

            // Título y ubicación
            Text("Fatal Accidente vía Tebaida", fontWeight = FontWeight.SemiBold)
            Text("Armenia, Quindío (2025)", fontSize = 13.sp, color = Color.Gray)
