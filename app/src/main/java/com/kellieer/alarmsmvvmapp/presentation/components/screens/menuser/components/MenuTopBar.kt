...
@Composable
fun MenuTopBar(navController: NavHostController) {
    ...
    ModalNavigationDrawer(
        ...
        TopBarContent(navController, backgroundColor, contentColor) {
...
fun DrawerContent(
    ...
    val selectedItem = remember { mutableStateOf("Explorar reportes nuevos") }
