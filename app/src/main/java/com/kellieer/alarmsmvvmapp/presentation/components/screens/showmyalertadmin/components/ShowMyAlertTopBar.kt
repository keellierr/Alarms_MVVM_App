...
@Composable
fun ShowMyAlertTopBar(navController: NavHostController) {
    ...
    ModalNavigationDrawer(
        ...
        drawerContent = {
            DrawerContentAdmin(scope, drawerState, isDarkTheme, navController, selectedItem)
        }
    ) {
        TopBarContentAdmin(navController, backgroundColor, contentColor) {
