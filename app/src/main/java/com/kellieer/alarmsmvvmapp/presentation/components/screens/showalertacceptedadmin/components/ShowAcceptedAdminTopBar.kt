package com.kellieer.alarmsmvvmapp.presentation.components.screens.showalertacceptedadmin.components
...
@Composable
fun ShowAcceptedAdminTopBar(navController: NavHostController) {
    val isDarkTheme = isSystemInDarkTheme()
    val backgroundColor = if (isDarkTheme) Color(0xFF1C1C1E) else Color(0xFFF2ECF7)
    val selectedItem = remember { mutableStateOf("Reportes aceptados") }
    ...
    ModalNavigationDrawer(
        ...
        drawerContent = {
            DrawerContent(scope, drawerState, isDarkTheme, navController, selectedItem)
        }
    ) {
        TopBarContentt( backgroundColor, contentColor) {
...
fun DrawerContent(
    ...
    Surface(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            val items = listOf(
                "Reportes pendientes" to Icons.Default.DateRange,
                    ...
                    modifier = Modifier
                        ...
                        .clickable {
                            ...
                            when (label) {
                                ...
                                "Guardados" -> {
                                    navController.navigate(AppScreens.ShowPinnedAdminScreen.route)
                                }
                            }
                        }
