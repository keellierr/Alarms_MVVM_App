package com.kellieer.alarmsmvvmapp.presentation.components.screens.showremovealert.components
...
@Composable
fun ShowRemoveTopBar(navController: NavHostController) {
...
fun DrawerContent(
    ...
    selectedItem: MutableState<String> = remember { mutableStateOf("Eliminar") }
) {
