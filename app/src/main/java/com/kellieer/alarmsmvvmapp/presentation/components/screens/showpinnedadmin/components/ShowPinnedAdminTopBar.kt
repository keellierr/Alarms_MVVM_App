package com.kellieer.alarmsmvvmapp.presentation.components.screens.showpinnedadmin.components
...
@Composable
fun ShowPinnedAdminTopBar(navController: NavHostController) {
    val isDarkTheme = isSystemInDarkTheme()
    val backgroundColor = if (isDarkTheme) Color(0xFF1C1C1E) else Color(0xFFF2ECF7)
    val selectedItem = remember { mutableStateOf("Guardados") }
                    ...
                    modifier = Modifier
                        ...
                        .clickable {
                            ...
                            when (label) {
                                ...
                                "Reportes aceptados" -> {
                                    navController.navigate(AppScreens.ShowAlertAcceptedAdminScreen.route)
                                }
                            }
                        }
